...
object RouteGhost {
     ...
     *                      the Virtual Partner target, falling back to the segments' own average.
     ...
     * Virtual Partner target is configured, so the ghost still flows at the rider's own typical pace.
     */
