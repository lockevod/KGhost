 ...
 *
 * Prefers shared external `/sdcard/KVPartner/tracks` so the user can browse, back up and restore
...
object TrackStorage {
    ...
    fun tracksDir(context: Context): File {
        ...
        val external = File(Environment.getExternalStorageDirectory(), "KVPartner/$DIR_NAME")
        return runCatching {
            external.mkdirs()
